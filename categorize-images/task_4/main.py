...
import csv 
train_writer = csv.writer(open("./train-res18.csv", 'w'))
test_writer = csv.writer(open("./test-res18.csv", 'w'))
...
my_transforms = transforms.Compose([transforms.Grayscale(),
                                    ...
                                    transforms.Resize(256), # 222 for WJNet
...
def train(epoch, writer):
    ...
    for batch_idx, (inputs, labels) in enumerate(train_loader):
        ...
        if batch_idx == 46:
            writer.writerow([epoch, (train_loss/(batch_idx+1)), (100.*float(correct.data[0])/float(total)) ])
...
def test(epoch, writer):
    ...
    for batch_idx, (inputs, targets) in enumerate(test_loader):
        ...
        if batch_idx == 4:
            writer.writerow([epoch, (test_loss/(batch_idx+1)), (100.*float(correct.data[0])/float(total)) ])
